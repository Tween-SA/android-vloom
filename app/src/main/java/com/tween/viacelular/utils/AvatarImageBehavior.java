...
/**
 * Created by davidfigueroa on 21/1/16.
 */
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView>
{
	...
	public AvatarImageBehavior(Context context, AttributeSet attrs)
	{
		mContext				= context;
		init();
		final float mFinalLeftAvatarPadding = context.getResources().getDimension(R.dimen.spacing_normal);
	}
	...
	private void maybeInitProperties(CircleImageView child, View dependency)
	{
		...
		{
			mFinalXPosition = mContext.getResources().getDimensionPixelOffset(R.dimen.spacing_normal) + (finalHeight / 2);
		}
