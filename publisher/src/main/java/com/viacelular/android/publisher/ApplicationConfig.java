...
public class ApplicationConfig
{
	...
	/**
	 * Specify which Google Play track you are publishing to. Valid values are:
	 * production
	 * alpha
	 * beta
	 * rollout
	 */
	static String TRACK = "production";
	 ...
	 */
	static String APPLICATION_NAME = "Vloom";

	/**
	 * Specify the package name of the app.
	 */
	static String PACKAGE_NAME = "com.tween.viacelular";
	 ...
	 * </p>
	 */
	public static String APK_FILE_PATH = "/resources/Vloom.apk";
}