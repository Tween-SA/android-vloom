...
public class AndroidPublisherHelper
{
	 ...
	 */
	private static final String SRC_RESOURCES_KEY_P12 = "/resources/main/key.p12";

	/**
	 * Path to the client secrets file (only used for Installed Application
	 * auth).
	 */
	private static final String RESOURCES_CLIENT_SECRETS_JSON = "/resources/main/client_secrets.json";
	...
	private static Credential authorizeWithInstalledApplication() throws IOException
	{
		...
		// load client secrets
		GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY, new InputStreamReader(AndroidPublisherHelper.class.getResourceAsStream(RESOURCES_CLIENT_SECRETS_JSON)));
